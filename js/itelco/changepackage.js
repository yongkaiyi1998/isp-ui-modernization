$(document).ready(function () {
    $('#changepackage_detail input').prop('readonly', true);
    $('#changepackage_detail select').prop('disabled', true);
    $('#changepackage_detail textarea').prop('readonly', true);
});
...
function ajax_filter(filter_pressed=0) {
	...
	$.ajax({
		type: "POST",
		url: base_url + "changepackage/changepackage_rows/0",
		data: { 
...
$('#changepackage_detail').submit(function(e) {
	e.preventDefault();
