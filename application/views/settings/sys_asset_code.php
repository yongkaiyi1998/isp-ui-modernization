	...
	<div class="panel panel-default">
			...
			<div>
				<h4>
					...
					<span class="myDivider" style="border-right: 1px solid rgba(0, 0, 0, 0.15); float:right;">
						<a href="<?php echo base_url('settings/add_asset_code');?>" style="margin-left: 5px; margin-right: 5px;" >
		...
		<div class="panel-body">
			...
			<div class="bg-success filter-bar">
				<form id="asset_code" name="asset_code" method="post" class="filter-form" action="<?php echo $form_action; ?>">
...
<script>
	function ajax_filter(filter_pressed=0) {
		...
		$.ajax({
			type: "POST",
			url: base_url + "settings/asset_code_management_rows/0",
			data: { 
