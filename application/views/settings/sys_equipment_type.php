	...
	<div class="panel panel-default">
			...
			<div>
				<h4>
					...
					<span class="myDivider" style="border-right: 1px solid rgba(0, 0, 0, 0.15); float:right;">
						<a href="<?php echo base_url('settings/add_equipment_type');?>" style="margin-left: 5px; margin-right: 5px;" >
		...
		<div class="panel-body">
			...
			<div class="bg-success filter-bar">
				<form id="equipment_type" name="equipment_type" method="post" class="filter-form" action="<?php echo $form_action; ?>">
...
<script>
	function ajax_filter(filter_pressed=0) {
		...
		$.ajax({
			type: "POST",
			url: base_url + "settings/equipment_type_management_rows/0",
			data: { 
