	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<form id="bill_type_detail" name="bill_type_detail" method="post" class="filter-form" action="<?php echo $form_action; ?>">
				<input type='hidden' id='product_code' name='product_code' value='<?php echo $input['product_code'] ?>' />
				<fieldset class='category-border-main'>	
					<div class="col-lg-6">							
						<div class="input-group">
							<span class="input-group-addon input_group">Product Name</span>
							<input type="text" class="form-control" id="name" name="name" value="<?php echo set_value('name', $input['product_name']); ?>" placeholder="Name">
						</div>
					</div>
				</fieldset>
				<div class="col-md-12">
