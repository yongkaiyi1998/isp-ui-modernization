<div class="container" >
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<form id="asset_site_detail" name="asset_site_detail" method="post" class="filter-form" action="<?php echo $form_action; ?>">
				<input type='hidden' id='site_code' name='site_code' value='<?php echo $input['site_code'] ?>' />
				<fieldset class='category-border-main'>	
					<div class="col-lg-6">							
						<div class="input-group">
							<span class="input-group-addon input_group">Site Name</span>
							<input type="text" class="form-control" id="site_name" name="site_name" value="<?php echo set_value('site_name', $input['site_name']); ?>" placeholder="Site Name">
						</div>
					</div>
				</fieldset>
				<div class="col-md-12">
...
<script>
	...
	$('#asset_site_detail').submit(function (e) {
		e.preventDefault();
