<div class="container" >
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<form id="equipment_type_detail" name="equipment_type_detail" method="post" class="filter-form" action="<?php echo $form_action; ?>">
				<input type='hidden' id='equipment_type_id' name='equipment_type_id' value='<?php echo $input['equipment_type_id'] ?>' />
				<fieldset class='category-border-main'>	
					<div class="col-lg-6">
						<div class="input-group">
							<span class="input-group-addon input_group">Equipment Type Name</span>
...
<script>
	...
	$('#equipment_type_detail').submit(function (e) {
		e.preventDefault();
