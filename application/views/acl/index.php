	...
	<div class="panel panel-default">
			...
			<div>
				<h4>
					...
					<span class="myDivider" style="border-right: 1px solid rgba(0, 0, 0, 0.15); float:right;">
						<a href="<?php echo base_url('acl/add_acl');?>" style="margin-left: 5px; margin-right: 5px;" >
		...
		<div class="panel-body">
			...
			<div class="bg-success filter-bar">
				<form id="acl" name="acl" method="post" class="filter-form" action="<?php echo $form_action; ?>">
