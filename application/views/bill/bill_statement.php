			...
			<div class="subpage">
							...
							<td width="45%" style="vertical-align:top">		
								<table border="0">
									<tr style="vertical-align:top">
										<td colspan='3' style="font-size:18px;"><?php echo $b_val['doc_title']; ?></td>
									</tr>
									<tr style="vertical-align:top">
				...
				<table class="summary-header" border="0" style="width:100%;font-size:13px;">
						<tr>
							...
							<td width="5%"></td>
							<td class="text-right to_underline" style="text-align:right;"  width="20%"><h5 style="font-family:sans-serif"><b>Total (<?php echo $c_val['currency_code']; ?>)</b></h5></td>
						</tr>
						<tr>
						...
						<tr>
							<td class="text-left " >Payment Received ( Thank you )</td>
							<td><b>:</b></td>
				...
				<table class="item_table" border="0" style="width:100%;font-size:13px;">
						...
						<tr>
							<td style="width:60%;border:0px;" class="text-left "><?php echo $b2_val['bill_type_name_with_remark']; ?></td>
				...
				<table class="account-summary" border="0" style="width:100%;font-size:13px;">
						...
						<tr>
							<td style="width:60%;" class="text-left" >Total</td>
							<td style="width:5%;"><b>:</b></td>
							<td class="text-right" style="text-align:right;width:20%;"><?php echo $b_val['charges']; ?></td>
							<td class="text-center"></td>
						</tr>						
						<tr>
							<td class="text-left">Service Tax <?php echo $c_val['default_tax']; ?>%</td>
							<td><b>:</b></td>
					...
					<div class="col-lg-12 balance_due well account-summary"  style="font-size:15px;">
						<table style="width:100%" border="0">
							<tr class="balance_due well" style="border:none;">
								<td width="60%" class="text-left "><b>Balance Due</b></td>
								<td width="5%"><b>:</b></td>
...
<div class="page bill_call" data-page="<?php echo $b_val['customer_no']; ?>" >
	<div class="subpage">
							...
							<td width="55%" style="vertical-align:top">
								<table border="0">
									...
									<tr>
										<td>User Name</td>
										<td>&nbsp;:&nbsp;</td>
										<td><?php echo $c_val['login_username']; ?></td>
									</tr>
									<tr style="vertical-align:top">
										<td>Deposit</td>
										<td>&nbsp;:&nbsp;</td>
				...
				<table class="summary-header" border="0" style="width:100%;font-size:13px;">
						<tr>
							<td class="to_underline" width="60%"><h5 style="font-family:sans-serif"><b>Phone Call Charges (Breakdown)</b></h5></td>
							<td width="5%"></td>
							<td class="text-right to_underline" style="text-align:right;"  width="20%"><h5 style="font-family:sans-serif"><b>Total (<?php echo $c_val['currency_code']; ?>)</b></h5></td>
						</tr>
				</table>
				<table class="item_table" border="0" style="width:100%;font-size:13px;">
						<tr>
							<td colspan="5"><h6 style="font-family:sans-serif"><b>CURRENT MONTH CHARGES</b></h6></td>
						</tr>
				...
				<div class="col-lg-12 balance_due well account-summary"  style="font-size:15px;">
					<table style="width:100%" border="0">
						<tr class="balance_due well" style="border:none;">
							<td width="60%" class="text-left "><b>Total</b></td>
							<td width="5%"><b>:</b></td>
