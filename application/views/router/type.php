		...
		<div class="panel-heading noprint">
			<div>
				<h4>
					...
					<?php if (check_acl('router', 'M', false)) {?>
					<span class="myDivider" style="border-right: 1px solid rgba(0, 0, 0, 0.15); float:right;">
						<a href="<?php echo base_url('router/add_router_type');?>" style="margin-left: 5px; margin-right: 5px;" >
...
<script>
	function ajax_filter(filter_pressed=0) {
		...
		$.ajax({
			type: "POST",
			url: base_url + "router/router_type_rows/0",
			data: { 
