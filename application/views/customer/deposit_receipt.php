	...
	<div class="page" style="min-height:148mm !important;width:206mm;"> 
		<div class="subpage" style="height:138mm !important;">
			...
			<table class="table table-condensed borderless" style="width:100%;">
				<tbody>
					<tr>
						...
						<td class="text-right col-lg-2" style="text-align:right;width:20%;vertical-align:bottom;" >Deposit No :</td>
						<td class="text-left col-lg-2"  style="width:15%;vertical-align:bottom;" >{payment_no}</td>
					</tr>
					<tr>
						
						<td class="text-right col-lg-2" style="text-align:right;width:20%;">Deposit Date :</td>
			...
			<div class="content_footer">					
				...
				<div>&nbsp;</div>
				<div style="color:brown; font-size:0.8em;"><i>For further information, kindly contact our call centre at 604-683 8888 or toll free 1-700-81-8862 or visit our website www.penangfon.com</i></div>
				<div>&nbsp;</div>					
			</div>
