	...
	<div class="panel panel-default">
		<div class="panel-heading noprint">
			<div>
				<h4>
					...
					<?php if (check_acl('adjustment', 'M', false)) {?>
					<span class="myDivider" style="border-right: 1px solid rgba(0, 0, 0, 0.15); float:right;">
						<a href="<?php echo base_url('adjustment/add_adjustment');?>" style="margin-left: 5px; margin-right: 5px;" >
		...
		<div class="panel-body">
			...
			<div class="bg-success filter-bar">
				<form id="adjustment" name="adjustment" method="post" class="filter-form" action="<?php echo $form_action; ?>">
