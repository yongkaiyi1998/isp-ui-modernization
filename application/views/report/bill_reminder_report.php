...
{
    var form = $('form');
    form.attr('action', base_url + 'report/export_bill_reminder_report');
    $('#btSubmit').click();
    form.attr('action', base_url + 'report/bill_reminder_report') ;
}
...
function ajax_filter() {
	...
	$.ajax({
		type: "POST",
		url: base_url + "report/bill_reminder_report_rows/0",
		data: { 
...
function ajax_clear() {
	...
	ajax_clear_session('report', 'report_bill_reminder_report_filter');
}
