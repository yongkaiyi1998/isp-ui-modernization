...
<script>
	...
	{
		var form = $('form');
		form.attr('action', base_url + 'report/export_planned_maintenance');
		//form.attr('target', '_blank');
		$('#btSubmit').click();
		form.attr('action', base_url + 'report/planned_maintenance') ;
...
$( document ).on("click", "#btPrint", function(e){
	var form = $('form');
	form.attr('action', base_url + 'report/planned_maintenance/print');
	form.attr('target', '_blank');
	$('#btSubmit').val("print");
	$('#btSubmit').click();
	form.attr('action', base_url + 'report/planned_maintenance');
...
function ajax_filter() {
	...
	$.ajax({
		type: "POST",
		url: base_url + "report/planned_maintenance_rows/0",
		data: { 
...
function ajax_clear() {
	...
	ajax_clear_session('report', 'report_planned_maintenance_filter');
}
