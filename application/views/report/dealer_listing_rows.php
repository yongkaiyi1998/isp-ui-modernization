	...
	<table class="table-striped">
		<thead>
			...
			<tr class="report_th" style="background: #289383; font-weight: bold; color: #fff;">
				...
				<!-- <th class="col-lg-1" <?php if ($isprint == 1) { echo 'style="width:10%;"'; } ?>>Source</th> -->
			...
			foreach ($data_row as $key => $val) {
				...
				foreach ($val as $key2 => $val2) {
					...
					foreach ($val2 as $val3) {
						...
						echo "<td class='small'>" . $val3['customer_no'] . "</td>";
						echo "<td class='small'>" . $val3['customer_name'] . "</td>";
						echo "<td class='small'>" . $val3['dealer_name'] . "</td>";
						echo "<td class='small'>" . $val3['top_level_agent_name'] . "</td>";
						echo "<td class='small'>" . $val3['building_name'] . "</td>";
						echo "<td class='small'>" . $val3['remark'] . "</td>";
						echo "<td class='small'>" . $val3['payment_no'] . "</td>";
						// echo "<td class='text-center small'>" . $val3['payment_source_name'] . ((strtolower($val3['payment_source_name'])=='paynet') ? ' ('.$val3['paynet_bank'].')' : '') . "</td>";
						echo "<td class='small'>" . $val3['cheque_no'] . "</td>";
