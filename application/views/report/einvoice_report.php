...
{
    var form = $('form');
    form.attr('action', base_url + 'report/export_einvoice_report');
    $('#btSubmit').click();
    form.attr('action', base_url + 'report/einvoice_report') ;
}
...
function ajax_filter() {
	...
	$.ajax({
		type: "POST",
		url: base_url + "report/einvoice_report_rows/0",
		data: { 
...
function ajax_clear() {
	...
	ajax_clear_session('report', 'report_einvoice_report_filter');
}
