...
{
    var form = $('form');
    form.attr('action', base_url + 'report/export_ifca_table');
    $('#btSubmit').click();
    form.attr('action', base_url + 'report/ifca_table') ;
}
...
function ajax_filter() {
	...
	$.ajax({
		type: "POST",
		url: base_url + "report/ifca_table_rows/0",
		data: { 
...
function ajax_clear() {
	...
	ajax_clear_session('report', 'report_ifca_table_filter');
}
