...
<script>
	...
	{
		var form = $('form');
		form.attr('action', base_url + 'report/export_asset_listing');
		//form.attr('target', '_blank');
		$('#btSubmit').click();
		form.attr('action', base_url + 'report/asset_listing') ;
...
$( document ).on("click", "#btPrint", function(e){
	var form = $('form');
	form.attr('action', base_url + 'report/asset_listing/print');
	form.attr('target', '_blank');
	$('#btSubmit').val("print");
	$('#btSubmit').click();
	form.attr('action', base_url + 'report/asset_listing');
...
function ajax_filter() {
	...
	$.ajax({
		type: "POST",
		url: base_url + "report/asset_listing_rows/0",
		data: { 
...
function ajax_clear() {
	...
	ajax_clear_session('report', 'report_asset_listing_filter');
}
