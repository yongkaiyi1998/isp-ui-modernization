...
<script>
	...
	{
		var form = $('form');
		form.attr('action', base_url + 'report/export_radius_radcheck');
		//form.attr('target', '_blank');
		$('#btSubmit').click();
		form.attr('action', base_url + 'report/radius_radcheck') ;
...
$( document ).on("click", "#btPrint", function(e){
	var form = $('form');
	form.attr('action', base_url + 'report/radius_radcheck/print');
	form.attr('target', '_blank');
	$('#btSubmit').val("print");
	$('#btSubmit').click();
	form.attr('action', base_url + 'report/radius_radcheck');
...
function ajax_filter() {
	...
	$.ajax({
		type: "POST",
		url: base_url + "report/radius_radcheck_rows/0",
		data: { 
...
function ajax_clear() {
	...
	ajax_filter();
	ajax_clear_session('report', 'report_radius_radcheck_filter');
}
