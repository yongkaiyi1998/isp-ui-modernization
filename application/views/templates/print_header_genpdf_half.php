...
<head>
	...
	<link rel="stylesheet" href="<?php if (!empty($local_base_url)) { echo $local_base_url."css/theme/print-style-pdf-half.css?1"; } else { echo base_url("css/theme/print-style-pdf-half.css?1"); } ?>"/>
