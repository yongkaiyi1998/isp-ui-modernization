  ...
  <div class="container">
	<div class="navbar-header" style="margin-top:4px;">
	  <div class="navbar-brand">
       ...
       &nbsp;
		  &nbsp;
		  <a style="cursor: pointer;" onclick="open_signature_popup();" data-toggle="tooltip" title="<?php echo ucwords(lang('tooltip_signature')); ?>">
        ...
        &nbsp;
            ...
            <div class="msg-print" style="float:right"></div>
