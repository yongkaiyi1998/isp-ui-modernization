<?php include 'panel_header.php';?>
		<div class="panel-heading noprint">
			<div>
				<h4>
					...
					<?php if (check_acl('salesorder', 'M', false)) {?>
					<span class="myDivider" style="border-right: 1px solid rgba(0, 0, 0, 0.15); float:right;">
						<a href="<?php echo base_url('salesorder/add_so');?>" style="margin-left: 5px; margin-right: 5px;">
		...
		<div class="panel-body">
			...
			<div class="bg-success filter-bar">
				<form id="salesorder" name="salesorder" method="post" class="filter-form" action="<?php echo $form_action; ?>" >
