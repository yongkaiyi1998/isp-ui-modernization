		...
		<div class="panel-body">
			...
			<div class="bg-success filter-bar">
				<form id="building" name="building" method="post" class="filter-form" action="<?php echo $form_action; ?>">
					...
					<button  id="btFilter" name="btFilter" type="button" value="filter" class="btn btn-success" onclick="ajax_transfer_list_filter(1)">
						<i class="menu-icon fa fa-filter white" data-toggle="tooltip" title=""></i>
						Filter
					</button>
					<button  id="btClear" name="btClear" type="button" value="clear" class="btn btn-info" onclick="ajax_transfer_list_clear()">
